	...
	<form id="formJoin" class="mb-5" action="/joinOk" method="POST">
        ...
        <div class="mb-3">
		  ...
		  <div class="alert alert-danger alert-dismissable" id="chkPwErrorRE"> <%-- RE : regular expression --%>
            <strong style="font-size: 15px;">[비밀번호 형식 오류] </strong> 비밀번호 형식을 지켜주세요.
          </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
	        ...
	        <select name="month" class="custom-select d-block w-100 col-md-4" id="month" required>
	          <option value="-1">선택하세요</option>
	        </select>
	        <select name="date" class="custom-select d-block w-100 col-md-4" id="date" required>
	          <option value="-1">선택하세요</option>
	        </select>
	      </div>
        </div>
        ...
        <div class="mb-3">
	      ...
	      <div class="input-group mb-2">
	        ...
	        <select name="email" class="custom-select d-block" id="suffixEmail" required>
			  <option value="-1">선택하세요</option>
