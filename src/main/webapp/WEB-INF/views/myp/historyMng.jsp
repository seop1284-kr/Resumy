	...
	<div class="container-md">
		...
		<article>
			...
			<h4><b>학력사항</b></h4>
				...
				<%-- 초등학교 정보 --%>
			<div class="school">
				<form name='spec01' id='spec01' onsubmit="return false;" method='post' height="300px"><br>
					<table  width="100%" >
						<tr>
							<td width="80%" colspan="2"><h5><b>초등학교 정보입력</b></h5></td>
							<td width="20%" style="text-align: right;"><button type="submit" style="width:80px;" class="btn btn-mint" name ="btnWriteSpec01" id ="btnWriteSpec01" >등록</button> <button type="submit" style="width:80px;" class="btn btn-mint" id ="btnUpdateSpec01" name ="btnUpdateSpec01" >수정</button></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="60%"><input type="text" id="schoolArea_01" name="area" value="" required></td>
							<td width="20%"></td>
						</tr>
					</table>
				...
				<%-- 중학교 정보 --%>
				<form name='spec02' id='spec02' onsubmit="return false;" method='post'><br>
					<table width="100%">
						<tr>
							<td width="80%" colspan="2"><h5><b>중학교 정보입력</b></h5></td>
							<td width="20%" style="text-align: right;"><button type="submit" style="width:80px;" class="btn btn-mint" id ="btnWriteSpec02" name ="btnWriteSpec02" >등록</button> <button type="submit" style="width:80px;" class="btn btn-mint" id ="btnUpdateSpec02" name ="btnUpdateSpec02" >수정</button></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="60%"><input type="text" id="schoolArea_02" name="area" value="" required></td>
							<td width="20%"></td>
						</tr>
					</table>
				...
				<%-- 고등학교 정보 --%>
				<form name='spec03' id='spec03' onsubmit="return false;" method='post'><br>
					<table  width="100%">
						<tr>
							<td width="80%" colspan="2"><h5><b>고등학교 정보입력</b></h5></td>
							<td width="20%" style="text-align: right;"><button type="submit" style="width:80px;" class="btn btn-mint" id ="btnWriteSpec03" name ="btnWriteSpec03" >등록</button> <button type="submit" style="width:80px;" class="btn btn-mint" id ="btnUpdateSpec03" name ="btnUpdateSpec03" >수정</button></td>
						</tr>
						<tr>
							<td width="20%">학교명</td>
						...
						<tr>
							<td width="20%">지역</td>
							<td width="60%"><input type="text" id="schoolArea_03"  name="area" value="" required></td>
							<td width="20%"></td>
						</tr>
						<tr>
							<td width="20%">전공</td>
				...
				<%-- 대학/대학원 정보 --%>
				<form name='spec04' id='spec04' onsubmit="return false;" method='post'><br>
					<table width="100%">
						<tr>
							<td width="80%" colspan="2"><h5><b>대학∙대학원 정보입력</b></h5></td>
							<td width="20%" style="text-align: right;"><button type="submit" style="width:80px;" class="btn btn-mint" id ="btnWriteSpec04" name ="btnWriteSpec04" >등록</button> <button type="submit" style="width:80px;"  class="btn btn-mint" id ="btnUpdateSpec04" name ="btnUpdateSpec04" >수정</button></td>
						</tr>
						<tr>
							<td width="20%">대학</td>
							<td width="60%">
						...
						<tr>
							<td width="20%">학교명</td>
							<td width="60%"><input type="text"  id ="school_04" name="name" value="" required></td>
							<td width="20%"></td>
						</tr>
						<tr>
							<td width="20%">지역</td>
							<td width="60%"><input type="text"  id ="schoolArea_04" name="area" value="" required></td>
							<td width="20%"></td>
						</tr>
						<tr>
							<td width="20%">전공계열</td>
